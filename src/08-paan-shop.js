...
export function createPaanOrder(basePaan, customizations) {
  if (!(typeof basePaan==='object') || Array.isArray(basePaan) || !basePaan || basePaan=={}) return {}
  if (!(typeof customizations==='object'|| Array.isArray(customizations) || !customizations || customizations =={})) return Object.assign({}, basePaan);
  return Object.assign({}, basePaan, customizations)
}

export function freezeMenu(menu) {
  if (!(typeof menu==='object') || Array.isArray(menu) || !menu || menu=={}) return {}
  return Object.freeze(menu);
}

export function updatePrices(menu, increase) {
  if (!(typeof menu==='object') || Array.isArray(menu) || !menu || menu=={} || isNaN(parseFloat(increase)) || increase==null || increase==undefined) return {}
  const newList = Object.entries(menu);
  newList.forEach(e => e[1] = e[1]+increase)
